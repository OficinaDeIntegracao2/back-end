...
export class SubjectService {
  ...
  create = async (professorId: string, name: string, description: string, weekdays: string, startTime: string, endTime: string, durationWeeks: string, totalHours: number): Promise<CreateOutput> => {
    try {
